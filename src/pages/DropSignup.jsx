...
const CulturalMark = () => (
  <div className="flex justify-center" style={{ marginBottom: '2.5rem' }}>
    ...
    >
      {/* Center line */}
      <line x1="0" y1="20" x2="200" y2="20" stroke="#F5F4F0" strokeWidth="0.5" />
...
export default function DropSignupPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Get the Drop First — Tee's and Steeze | Streetwear Drops Nigeria</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Get the Drop First — Tee's and Steeze" />
        <meta property="og:description" content="Early access. Limited pieces. No noise." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://teesandsteeze.com/drop" />
        <meta property="og:image" content="https://teesandsteeze.com/og-drop.jpg" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Get the Drop First — Tee's and Steeze" />
        <meta name="twitter:description" content="Early access to every release. No spam. Just the drop." />
      </Helmet>
      ...
      >
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--color-steeze-green-hover)' }}
                  onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--color-steeze-green)' }}
                >
                  Put me on the list
                </button>
        ...
        >
          <svg
            ...
            fill="none"
          >
            <line x1="0" y1="16" x2="1200" y2="16" stroke="#F5F4F0" strokeWidth="0.5" />
